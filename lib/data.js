export const portfolio = {
    ...
    real : [
        {
            title : "海報生成系統（DEMO版本）",
            subtitle : "前端操作頁面 + 後端Adobe Script海報生成^t前端、後端",
            language : "JavaScript + NextJS / Adobe Illustrator Script",
            img : [
                "/images/portfolio/poster-generator1.png",
                "/images/portfolio/poster-generator2.png",
            ],
            link : "https://nx-poster-generator.vercel.app/projects/NX0000000393",
            body : `
                海報生成系統（DEMO版本）。^t
                　^t
                因是個人作品集Demo版本，^t
    ...
    others : [{
        ...
        language : "JavaScript + jQuery",
        img : [
            "/images/portfolio/wang-tainan1.png"
        ],
        ...
        language : "JavaScript + jQuery",
        img : [
            "/images/portfolio/lcvs-project1.jpg"
        ],
